...
export const COOKIES_FILE = process.env.COOKIES_FILE || resolve(ROOT, "cookies.json");
export const DOWNLOADS_DIR = process.env.DOWNLOADS_DIR || resolve(ROOT, "reports-pdf");
